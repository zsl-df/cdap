...
public class PluginInfo extends PluginSummary {
  ...
  public PluginInfo(PluginClass pluginClass, ArtifactSummary artifactSummary) {
    this(pluginClass.getName(), pluginClass.getType(), pluginClass.getDescription(), pluginClass.getPluginFunction(), 
         pluginClass.getPluginInput(), pluginClass.getPluginOutput(), pluginClass.getClassName(),
         pluginClass.getConfigFieldName(), artifactSummary, pluginClass.getProperties(), pluginClass.getEndpoints());
  }

  public PluginInfo(String name, String type, String description, String[] pluginInput, 
		            String[] pluginOutput, String[] pluginFunction, String className, @Nullable String configFieldName,
