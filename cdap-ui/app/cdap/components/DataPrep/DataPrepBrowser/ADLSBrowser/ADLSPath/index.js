...
import {setADLSPrefix} from 'components/DataPrep/DataPrepBrowser/DataPrepBrowserStore/ActionCreator';

class ADLSPath extends FilePath {
  constructor(props) {
    super(props);
  }
  processPath(props) {
...
const ADLSPathWrapper = connect(mapStateToProps, mapDispatchToProps)(ADLSPath);

export default ADLSPathWrapper;
