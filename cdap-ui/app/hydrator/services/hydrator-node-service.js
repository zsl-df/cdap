...
class HydratorPlusPlusNodeService {
  ...
  shouldPropagateSchemaToNode(targetNode) {
    if (targetNode.implicitSchema || targetNode.type === 'batchjoiner' || targetNode.type === 'sparkjoiner' || targetNode.type === 'sparkdataframejoiner' || targetNode.type === 'splittertransform') {
      return false;
    }
