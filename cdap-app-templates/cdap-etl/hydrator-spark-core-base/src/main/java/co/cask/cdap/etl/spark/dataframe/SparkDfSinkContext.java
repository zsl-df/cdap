 ...
 */
public class SparkDfSinkContext extends AbstractBatchContext implements BatchSinkContext {
  private final SparkDfSinkFactory sinkFactory;
  private final boolean isPreviewEnabled;

  public SparkDfSinkContext(SparkDfSinkFactory sinkFactory, SparkClientContext sparkContext,
  ...
  public SparkDfSinkContext(SparkDfSinkFactory sinkFactory, JavaSparkExecutionContext sec,
