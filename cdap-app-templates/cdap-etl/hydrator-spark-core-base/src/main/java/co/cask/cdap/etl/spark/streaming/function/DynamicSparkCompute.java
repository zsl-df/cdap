 ...
 */
public class DynamicSparkCompute<T, U> extends SparkDataframeCompute<T, U> {
  private final DynamicDriverContext dynamicDriverContext;
  private transient SparkDataframeCompute<T, U> delegate;

  public DynamicSparkCompute(DynamicDriverContext dynamicDriverContext, SparkDataframeCompute<T, U> compute) {
