 ...
 */
public class WrappedSparkDataframeSink<IN> extends SparkDataframeSink<IN> {
  private final SparkDataframeSink<IN> sink;
  private final Caller caller;

  public WrappedSparkDataframeSink(SparkDataframeSink<IN> sink, Caller caller) {
    this.sink = sink;
    this.caller = caller;
  }
  ...
  @Override
  public void run(final SparkExecutionPluginContext context, final Dataset input) throws Exception {
   caller.call(new Callable<Void>() {
     @Override
     public Void call() throws Exception {
