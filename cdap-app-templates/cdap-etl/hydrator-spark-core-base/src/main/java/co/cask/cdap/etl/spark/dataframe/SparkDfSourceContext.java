 ...
 */
public class SparkDfSourceContext extends AbstractBatchContext
  implements BatchSourceContext, StageSubmitterContext {
  private final SparkDfSourceFactory sourceFactory;
  private final boolean isPreviewEnabled;
  private final SparkClientContext sparkContext;

  public SparkDfSourceContext(SparkDfSourceFactory sourceFactory, SparkClientContext sparkContext,
