 ...
 */
public class DynamicSparkDataframeJoiner< U> extends SparkDataframeJoiner<U> {
  private final DynamicDriverContext dynamicDriverContext;
  private transient SparkDataframeJoiner<U> delegate;

  public DynamicSparkDataframeJoiner(DynamicDriverContext dynamicDriverContext, SparkDataframeJoiner<U> compute) {
  ...
  public Dataset join(SparkExecutionPluginContext context, Map<String, Dataset> inputs) throws Exception {
    ...
    Dataset input = inputs.values().iterator().next();
