...
public class ListArtifactPluginsCommand extends AbstractAuthCommand {
  ...
  public void perform(Arguments arguments, PrintStream output) throws Exception {
    ...
    Table table = Table.builder()
      .setHeader("type", "name", "classname", "description", "artifact", "pluginInputTypes", "pluginOutputTypes", "pluginFunctions")
      .setRows(pluginSummaries, new RowMaker<PluginSummary>() {
        ...
        public List<?> makeRow(PluginSummary object) {
          return Lists.newArrayList(
            ...
            object.getArtifact().toString(), object.getPluginInputToString(), object.getPluginOutputToString(), object.getPluginFunctionToString());
        }
      }).build();
