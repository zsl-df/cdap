...
public class JSONInputParser {
    ...
    public static void main(String args[]) {
        String pluginConfig = "{\"artifact\":{\"name\":\"cdap-data-pipeline\",\"version\":\"5.0.0\",\"scope\":"
                ...
                + "\"7012e054000b06d5d83b4366f6bd98ca\",\"directives\":\"parse-as-csv :body ',' false\\ndrop body\","
                + "\"schema\":\"{\\\"name\\\":\\\"avroSchema\\\",\\\"type\\\":\\\"record\\\",\\\"fields\\\":"
                + "[{\\\"name\\\":\\\"body_1\\\",\\\"type\\\":[\\\"string\\\",\\\"null\\\"]},{\\\"name\\\":"
                + "\\\"body_2\\\",\\\"type\\\":[\\\"string\\\",\\\"null\\\"]},{\\\"name\\\":\\\"body_3\\\","
                + "\\\"type\\\":[\\\"string\\\",\\\"null\\\"]},{\\\"name\\\":\\\"body_4\\\",\\\"type\\\":"
                + "[\\\"string\\\",\\\"null\\\"]}]}\",\"field\":\"body\",\"precondition\":\"false\",\"threshold\":"
                + "\"1\"}}},{\"name\":\"File\",\"plugin\":{\"name\":\"File\",\"label\":\"File\",\"type\":"
                + "\"batchsource\",\"artifact\":{\"name\":\"core-plugins\",\"version\":\"[1.7.0, 3.0.0)\",\"scope\":"
                + "\"SYSTEM\"},\"properties\":{\"path\":\"file:/Users/bhupesh.goel/Documents/AnalyticsEngine/"
                + "AutoFeatureEngineeringPOC/customers.csv\",\"ignoreNonExistingFolders\":\"false\",\"recursive\":"
                + "\"false\",\"referenceName\":\"customers.csv\"}}}],\"connections\":[{\"from\":\"File\",\"to\":"
        ...
        String dataSchema = "[{\"name\": \"etlSchemaBody\",\"schema\": {\"type\": \"record\",\"name\": "
                + "\"etlSchemaBody\",\"fields\": [{\"name\": \"body_1\",\"type\": [\"string\",\"null\"]},{\"name\": "
                + "\"body_2\",\"type\": [\"string\",\"null\"]},{\"name\": \"body_3\",\"type\": [\"string\",\"null\"]},"
                + "{\"name\": \"body_4\",\"type\": [\"string\",\"null\"]}]}}]";
