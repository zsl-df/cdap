...
public class AutoFeatureGenerationEndPointTest {
	...
	public static void main(String args[]) throws ClientProtocolException, IOException {
		String url = "http://bhupesh-goel.local:11015/v3/namespaces/default/apps/FeatureEngineeringApp/services/AutoFeatureGenerationService/methods/featureengineering/InputX1ErrorTestPipeline/features/create";
...
//		dataSchemaNames.add("5e1f4773cbd4174d0b07169ad7ab9916");
		...
		// accounts.account_id:errors.account_id:errors.event_cause_id;errors.event_cause_category,accounts.account_id:errors.account_id:errors.device_video_firmware;errors.device_video_model
